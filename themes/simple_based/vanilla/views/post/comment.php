...
<div class="MessageForm CommentForm">
   ...
   */
   ...
   $CancelText = '&larr; Назад к всем темам';
   $CancelClass = 'Back';
   if (!$NewOrDraft) $CancelText = $CancelClass = 'Cancel';
   ...
   */
   ...
   echo '<br class="clear">'.$this->Form->Button($Editing ? 'Save Comment' : 'Post Comment', $ButtonOptions);
   
   $this->FireEvent('AfterFormButtons');
   
   echo '<br><br>',Anchor(T($CancelText), 'discussions', $CancelClass);
   echo "</div>\n";
